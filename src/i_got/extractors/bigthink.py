...
class Bigthink(VideoExtractor):
    ...
    def get_streams_by_id(account_number, video_id):
        ...
        """
        endpoint = "https://edge.api.brightcove.com/playback/v1/accounts/{account_number}/videos/{video_id}".format(
        ...
        fake_header_id[
            "Accept"
        ] = "application/json;pk=BCpkADawqM1cc6wmJQC2tvoXZt4mrB7bFfi6zGt9QnOzprPZcGLE9OMGJwspQwKfuFYuCjAAJ53JdjI8zGFx1ll4rxhYJ255AXH1BQ10rnm34weknpfG-sippyQ"
