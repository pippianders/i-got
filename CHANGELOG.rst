...
* New site support:
    - 755 http://7gogo.jp/ (via #659 by @pippianders)
...
* Bug fixes:
    ...
    - QQ (by @pippianders)
    - SoundCloud (by @pippianders)
    - Tudou (by @CzBiX)
    - Vimeo channel (by @cnbeining)
    - YinYueTai (by @pippianders)
    - Youku (by @junzh0u)
...
* iQIYI: fix `#77 <https://github.com/pippianders/i-got/issues/77>`_.
...
* Sohu: fix `#69 <https://github.com/pippianders/i-got/issues/69>`_.
...
* Sohu:
    - fix `#53 <https://github.com/pippianders/i-got/issues/53>`_.
    - merge pull request `#54 <https://github.com/pippianders/i-got/pull/54>`_; downloading best quality available now.
...
* YouTube: fix `#45 <https://github.com/pippianders/i-got/issues/45>`_.
* Merge pull request `#46 <https://github.com/pippianders/i-got/pull/46>`_; fix title parsing issue on Tudou.
...
* YouTube: quick dirty fix to `#45 <https://github.com/pippianders/i-got/issues/45>`_.
...
* Fix issues `#42 <https://github.com/pippianders/i-got/issues/42>`_, `#43 <https://github.com/pippianders/i-got/issues/43>`_ for Google+.
* Merge pull request `#40 <https://github.com/pippianders/i-got/pull/40>`_; fix some issues for Ku6, Sina and 56.
...
* Fix issue `#30 <https://github.com/pippianders/i-got/issues/30>`_ for bilibili.
...
* Fix issue `#28 <https://github.com/pippianders/i-got/issues/28>`_ for Tudou.
...
* Fix issue `#20 <https://github.com/pippianders/i-got/issues/20>`_ for AcFun.
...
* Fix issues:
    - `#17 <https://github.com/pippianders/i-got/issues/17>`_
    - `#18 <https://github.com/pippianders/i-got/issues/18>`_
    - `#19 <https://github.com/pippianders/i-got/issues/19>`_
...
* Fix issue `#16 <https://github.com/pippianders/i-got/issues/16>`_.
...
* Fix issue `#15 <https://github.com/pippianders/i-got/issues/15>`_ for AcFun.
...
* Fix issue `#6 <https://github.com/pippianders/i-got/issues/6>`_ for YouTube.
...
* Fix issue `#5 <https://github.com/pippianders/i-got/issues/5>`_ for YinYueTai.
...
* Fix issue `#2 <https://github.com/pippianders/i-got/issues/2>`_ and `#4 <https://github.com/pippianders/i-got/issues/4>`_ for YouTube.
...
* First PyPI release.
* Fix issue `#1 <https://github.com/pippianders/i-got/issues/1>`_.
